...
RUN    apt-get update -qq \
    && apt-get -qq install -y autoconf build-essential m4 libreadline6-dev \
                              libncurses5-dev curl wget unzip libgmp3-dev \
                              cmake gcc g++ sudo
...
RUN    mkdir -p /home/gap/inst \
    && cd /home/gap/inst \
    && curl --fail -L -O https://www.gap-system.org/pub/gap/gap4core/gap-${GAP_VERSION}-core.zip \
    ...
    && curl --fail -L -O https://github.com/gap-packages/PackageManager/archive/v1.1.tar.gz \
